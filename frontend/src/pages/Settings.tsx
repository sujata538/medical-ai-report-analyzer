  ...
  return (
    <div className="mx-auto max-w-2xl px-6 py-10">
      ...
      <section className="card mb-6">
        ...
        {message && (
          <p className="mb-3 rounded-md bg-sage-light px-3 py-2 text-sm text-sage">
            {message}
          </p>
        )}

        {error && (
          <p className="mb-3 rounded-md bg-coral-light px-3 py-2 text-sm text-coral">
            {error}
          </p>
        )}
      ...
      <p className="text-center text-xs text-ink/40">
        ...
        informational purposes and is NOT a substitute for
